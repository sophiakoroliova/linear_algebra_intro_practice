...
Порівняння метрик показує, що **лінійна регресія** без регуляризації досягає MSE = 2900.19 та R^2 = 0.453, що свідчить про помірну ефективність, але з ризиком перенавчання через відсутність штрафу за великі коефіцієнти. Модель **Ridge з L2-регуляризацією** покращує показники до MSE = 2875.67 та R^2 = 0.457 (менше MSE, вище R^2) зменшуючи амплітуду коефіцієнтів і підвищуючи стійкість до шуму. **Lasso з L1-регуляризацією** демонструє найкращі результати (MSE = 2824.10, R^2 = 0.467), оскільки не тільки згладжує коефіцієнти, але й виконує відбір ознак шляхом обнулення менш релевантних.
