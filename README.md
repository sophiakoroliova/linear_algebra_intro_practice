...
Коефіцієнти без регуляризації мають значну амплітуду (від -352 до 352), що свідчить про перенавчання. L2-регуляризація згладжує їх (від -1.36 до 0.67), забезпечуючи стабільність. L1-регуляризація обнуляє багато коефіцієнтів (наприклад, перші сім), виконуючи ефективний відбір ознак.
